...
export default function WineriesPage() {
    ...
    const warehousesFakesFiltered = useSearch({
        fields: warehousesFakes,
        searchTerm
    });
    ...
    const { finalIndex, totalPages, initialIndex } = usePagination({
        totalElements: warehousesFakesFiltered.length,
        elementsPerPag: 6,
        currentPage
    });
    const wineriesPagination = warehousesFakesFiltered.slice(initialIndex, finalIndex + 1);
    ...
    return (
        <>
            ...
            <Table>
                ...
                <BodyTable>
                    {wineriesPagination.map((warehouse) => (
